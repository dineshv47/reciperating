				...
				<div class="col-lg-9 border-end-0 bg-white">
					<div class="row g-0">
						...
						if (isset($_GET) && $_GET['query'] != '') {
							$sql = "SELECT * FROM recipes WHERE title LIKE '%" . $_GET['query'] . "%'";
									...
									<div class="card">
										<div class="card-body">
											...
											<div class="d-flex justify-content-between align-items-center mt-4 mb-2">
												...
												<span class="badge bg-primary bg-color"><i class="icon-star3"></i> <?php echo round($rating, 0) ?></span>
											</div>
						...
						<div class="col-lg-12 col-md-4 col-12 mt-5 mt-md-0 widget border-0 widget_links clearfix">
							...
							<ul>
								...
								?>
										...
										<li><a href="<?php echo BASE_URL; ?>recipes.php?id=<?php echo $row->id; ?>"><?php echo $row->title; ?></a></li>
								<?php
									}
								}
								?>
